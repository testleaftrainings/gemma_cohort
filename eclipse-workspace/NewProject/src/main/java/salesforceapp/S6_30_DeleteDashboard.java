...
public class S6_30_DeleteDashboard {
	...
	//Click View All and click Dashboards from App Launcher
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//button[text()='View All']")));
	...
	//Search the Dashboard 'Salesforce Automation by *Your Name*'
		...
		wait1.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//a[@title='Test_Delete']")));
		driver.findElement(By.xpath("(//tr//td[6]//span)[1]")).click();
