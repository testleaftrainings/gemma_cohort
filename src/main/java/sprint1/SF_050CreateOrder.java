...
public class SF_050CreateOrder extends  BaseClass {

    @Test
    public void tc_050CreateOrder() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//div[@id='navMenuList']//span[contains(text(),'Orders')]")).click();
        Thread.sleep(2000);
